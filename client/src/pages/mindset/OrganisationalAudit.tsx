    ...
    domains: [
      {
        ...
        level5: 'Living policy updated quarterly based on capability data and incident analysis',
      },
      {
        id: 'GO2',
        domain: 'Decision authority',
        level1: 'No clarity on which decisions require human judgement',
        level3: 'High-stakes decision categories defined with mandatory human review',
        level5: 'Decision authority matrix dynamically adjusted based on measured human capability and AI reliability',
      },
      {
        id: 'GO3',
        domain: 'Override procedures',
        level1: 'No defined override process',
        level3: 'Documented procedures for overriding AI recommendations, with no-blame protections',
        level5: 'Override data analysed for patterns; override rates tracked as a health metric',
      },
      {
        id: 'GO4',
        domain: 'Role clarity',
        ...
        level5: 'Role boundaries reviewed quarterly; boundary drift actively monitored',
      },
      {
        id: 'GO5',
        ...
        level5: 'Accountability framework tested via tabletop exercises; near-miss reporting active',
      },
    ],
  },
  {
    ...
    domains: [
      {
        ...
        level3: 'Annual skills assessment covers core professional competencies',
        level5: 'Continuous capability tracking with trend analysis; atrophy alerts automated',
      },
      {
        id: 'RO2',
        ...
        level5: 'Quarterly unannounced capability tests with realistic scenarios; results drive training',
      },
      {
        id: 'RO3',
        ...
        level5: 'Individualised capability maintenance plans; practice frequency calibrated to measured atrophy rates',
      },
      {
        id: 'RO4',
        domain: 'Onboarding',
        level1: 'New employees learn AI tools without human-first foundation',
        level3: 'Onboarding includes AI-free competency demonstration before AI tool access',
        level5: '"Norms before tools" programme: cultural expectations, independent capability, and critical thinking established before any AI training',
      },
      {
        id: 'RO5',
        domain: 'Succession resilience',
        level1: 'Critical knowledge exists only in AI systems or single individuals',
        level3: 'Knowledge documentation independent of AI platforms; cross-training covers key roles',
        level5: 'No single point of failure — human or AI. Knowledge resilience tested via "key person unavailable" exercises',
      },
    ],
  },
  {
    ...
    domains: [
      {
        ...
        level3: 'Policy requires at least two independent sources for significant analyses',
        level5: 'Advisory pluralism audited; teams track AI-agreement vs. independent-source-disagreement rates',
      },
      {
        id: 'IO2',
        ...
        level5: 'Automated verification pipelines for factual claims; human audit for reasoning and framing',
      },
      {
        id: 'IO3',
        domain: 'Vendor independence',
        level1: 'Institutional knowledge embedded in single AI platform',
        level3: 'Documentation in platform-independent formats; data export tested annually',
        level5: 'Multi-platform strategy; switching cost below defined threshold; annual portability drill',
      },
      {
        id: 'IO4',
        domain: 'Transparency requirements',
        level1: 'No visibility into AI reasoning or limitations',
        level3: 'AI tools configured to surface confidence levels and limitations',
        level5: 'Full audit trail of AI inputs, reasoning, and human modifications for all significant decisions',
      },
      {
        id: 'IO5',
        domain: 'Anchoring resistance',
        level1: 'No awareness of AI anchoring effects',
        level3: 'Training covers anchoring bias; "think first" protocols for key decisions',
        level5: 'Measured anchoring rates via blind comparison studies; interventions targeted at high-anchoring teams',
      },
    ],
  },
  {
    ...
    domains: [
      {
        ...
        level3: 'Teams routinely question and modify AI output; rejection rates tracked',
        level5: '"Red team" reviews of AI-assisted work; devil\'s advocate roles assigned for major decisions',
      },
      {
        id: 'PO2',
        domain: 'Dissent protection',
        level1: 'Employees penalised for slowing down AI-assisted workflows',
        level3: 'No-blame policy for AI output rejection; dissent from AI recommendations encouraged',
        level5: 'Dissent metrics tracked and rewarded; employees recognised for catching AI errors',
      },
      {
        id: 'PO3',
        domain: 'Multi-agent approaches',
        level1: 'Single AI tool per workflow',
        level3: 'Critical analyses use multiple AI models or human-AI debate protocols',
        level5: 'Heterogeneous AI ensembles with adversarial review for high-stakes work',
      },
      {
        id: 'PO4',
        ...
        level5: 'Active participation in AI evaluation benchmarks; organisational sycophancy rates measured and reported',
      },
      {
        id: 'PO5',
        domain: 'Innovation through friction',
        level1: 'AI used to reduce effort, not improve thinking',
        level3: 'AI configured to challenge assumptions and generate alternatives',
        level5: 'Human-AI creative tension systematically cultivated; "productive discomfort" embedded in workflows',
      },
    ],
  },
]
...
const maturityLevels = [
  { level: 1, label: 'Ad hoc', description: 'No formal approach. AI usage is unmanaged. Success depends on individual judgement.' },
  { level: 2, label: 'Aware', description: 'Risks are recognised. Some informal guidelines exist. No systematic monitoring.' },
  { level: 3, label: 'Structured', description: 'Formal policies exist. Regular assessments conducted. Roles and responsibilities defined.' },
  { level: 4, label: 'Measured', description: 'Quantitative metrics track AI dependency and human capability. Data drives decisions. Audits are regular and evidence-based.' },
  { level: 5, label: 'Adaptive', description: 'Continuous improvement embedded. Organisation proactively adjusts AI usage based on capability data. Innovation in human-AI collaboration is systematically pursued.' },
]
...
const scoreBands = [
  ...
  },
  {
    ...
    riskLevel: 'Elevated',
    color: 'yellow',
    action: 'Significant gaps exist. Implement the Privy Council Model within one quarter. Commission external audit.',
    interpretation:
  ...
  },
  {
    ...
    riskLevel: 'High',
    color: 'red',
    action: 'AI fire drill within 30 days. Capability baseline assessment. Policy development sprint.',
    interpretation:
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 text-lg mb-4">
          This audit is designed for teams and organisations. It should be completed by a
          cross-functional group including leadership, operational staff, and IT — not by a
          single person.
        </p>
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
          <strong>Instructions:</strong> Use evidence where possible (documented policies, test
          results, actual incident data) rather than aspirational self-assessment. Each domain
          uses a <strong>5-level maturity scale</strong> from Ad hoc (1) to Adaptive (5).
        </div>
      </div>
      ...
      <div className="mb-8 border border-gray-200 rounded-xl overflow-hidden">
        <div className="px-5 py-3 bg-gray-50 border-b border-gray-200">
          <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wide">Maturity scale reference</h2>
        </div>
        <div className="divide-y divide-gray-100">
          {maturityLevels.map((level) => (
            <div key={level.level} className="px-5 py-3 flex gap-4 items-start text-sm">
              <span className="font-bold text-gray-900 w-4 flex-shrink-0">{level.level}</span>
              <span className="font-semibold text-gray-700 w-24 flex-shrink-0">{level.label}</span>
      ...
      <div className="mb-8">
        <div className="flex justify-between text-sm text-gray-500 mb-1">
          <span>{answeredDomains} of {totalDomains} domains scored</span>
      ...
      {sections.map((section) => {
        ...
        const sectionAnswered = section.domains.filter((d) => scores[d.id] !== undefined).length
            ...
            <div className="divide-y divide-gray-100">
              {section.domains.map((domain) => (
                <div key={domain.id} className="px-6 py-5">
                  <div className="mb-3">
                    <span className="text-xs font-mono text-gray-400 mr-2">{domain.id}</span>
                    <span className="font-semibold text-gray-800">{domain.domain}</span>
                  </div>

                  {/* Level anchors */}
                  <div className="mb-4 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    <div className="bg-red-50 border border-red-100 rounded-lg p-2.5">
                      <div className="font-semibold text-red-700 mb-1">Level 1 — Ad hoc</div>
                      <p className="text-red-600 leading-relaxed">{domain.level1}</p>
                    </div>
                    <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-2.5">
                      <div className="font-semibold text-yellow-700 mb-1">Level 3 — Structured</div>
                      <p className="text-yellow-700 leading-relaxed">{domain.level3}</p>
                    </div>
                    <div className="bg-green-50 border border-green-100 rounded-lg p-2.5">
                      <div className="font-semibold text-green-700 mb-1">Level 5 — Adaptive</div>
                      <p className="text-green-600 leading-relaxed">{domain.level5}</p>
                    </div>
                  </div>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className={`border-2 rounded-xl p-6 ${resultColorClasses[currentBand.color]}`}>
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
              ...
              <div className="text-right flex flex-col items-end gap-2">
                ...
                <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${riskBadgeClasses[currentBand.riskLevel]}`}>
              ...
              {sections.map((section) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500 mb-2">{section.title}</div>
          ...
          {criticalPillars.length > 0 && (
            <div className="border-2 border-red-400 bg-red-50 rounded-xl p-6">
              ...
              <p className="text-red-700 text-sm mb-3">
                Any single pillar scoring below 10 represents a systemic risk regardless of
                your total score. The following pillars require immediate attention:
              </p>
              <ul className="space-y-2">
                {criticalPillars.map((s) => (
                  <li key={s.key} className="flex items-start gap-2 text-sm text-red-700">
                    <span className="font-bold mt-0.5">Pillar {s.key}:</span>
                    <span>
                      {s.title} — scored {sectionScores[s.key]}/25.
                      {s.key === 'R' && ' This is the al-Mansur pattern — everything looks excellent until AI fails or the vendor relationship changes.'}
                      {s.key === 'G' && ' Without governance guardrails, AI usage is effectively unmanaged at the organisational level.'}
                      {s.key === 'I' && ' A critical information integrity gap means AI may be constructing your organisation\'s reality without verification.'}
                      {s.key === 'P' && ' Without productive friction, AI output is being treated as authoritative across the organisation.'}
                    </span>
                  </li>
                ))}
              </ul>
              ...
              {sections.map((section) =>
                section.domains.map((domain, idx) => {
                  ...
                  return (
                    <div
                      key={domain.id}
                      className={`grid grid-cols-12 px-4 py-3 text-sm items-center ${isLast ? 'border-b-2 border-gray-300' : 'border-b border-gray-100'}`}
                    >
                      <div className="col-span-1 font-mono text-xs text-gray-400">{domain.id}</div>
                      <div className="col-span-7 text-gray-700">{domain.domain}</div>
                      <div className="col-span-2 text-center font-bold text-gray-900">{score}</div>
          ...
          <div className="border border-gray-200 bg-white rounded-xl p-6">
            ...
            <div className="space-y-4 text-sm text-gray-700">
              <div>
                <div className="font-semibold text-gray-800 mb-1">Weeks 1–2</div>
                <p>Leadership reviews this audit report. Identify the lowest-scoring pillar and the three most critical domain gaps. Commission an external assessment if internal scoring seems optimistic.</p>
              </div>
              <div>
                <div className="font-semibold text-gray-800 mb-1">Weeks 3–4</div>
                <p>Establish foundational policies — AI usage policy, decision authority matrix, and override procedures. Share research data (17% performance drops, 58% sycophancy rates, 20% accuracy declines) to build urgency.</p>
              </div>
              <div>
                <div className="font-semibold text-gray-800 mb-1">Months 2–3</div>
                <p>Conduct the first AI fire drill. Establish capability baseline. Begin the knowledge resilience documentation programme. Implement quarterly GRIP tracking at both individual and organisational levels.</p>
              </div>
            </div>
          </div>
