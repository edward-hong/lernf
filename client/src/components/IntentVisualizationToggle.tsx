// ---------------------------------------------------------------------------
// Intent Visualization Settings Toggle
// ---------------------------------------------------------------------------
// Control panel for enabling/disabling intent visualization and adjusting
...
export function IntentVisualizationToggle({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      ...
      {/* Additional controls shown only when enabled */}
      {settings.enabled && (
        <>
