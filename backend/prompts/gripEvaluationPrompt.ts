// ---------------------------------------------------------------------------
// GRIP Evaluation Prompt Builder (Backend)
// ---------------------------------------------------------------------------
// Builds the comprehensive GRIP evaluation prompt. This is the authoritative
 ...
 * @param scenarioCategory - The scenario category
 * @param scenarioEngineBriefing - Internal engine briefing (not shown to user)
 * @param conversationHistory - Pre-formatted conversation history string
 * @param signalsSummary - Pre-formatted evaluation signals summary
 * @param hiddenFactorStatus - Pre-formatted hidden factor discovery status
 * @param evaluationGuidance - Pre-formatted dimension-specific guidance
 * @param userTurnCount - Number of user turns in the conversation
 * @param minTurnsForFullEvaluation - Minimum turns needed for meaningful evaluation
 */
export function buildGripEvaluationPrompt(
...
**Engine Briefing:** ${scenarioEngineBriefing}
