// ---------------------------------------------------------------------------
// Consequence Generation Prompt Builder (Backend)
// ---------------------------------------------------------------------------
...
/**
 * Builds the consequence generation prompt.
 *
 * @param scenarioTitle - The scenario title
 * @param scenarioCategory - The scenario category
 * @param scenarioSetupContext - The scenario's setup context
 * @param conversationSummary - Pre-formatted conversation summary
 * @param gripScores - Pre-formatted GRIP dimension scores
 * @param compositeScore - Overall composite score (1-5)
 * @param band - Evaluation band label
 * @param hiddenFactorStatus - Pre-formatted hidden factor discovery status
 * @param weakDimensions - Array of dimension letters with scores <= 2
 */
export function buildConsequenceGenerationPrompt(
...
**Setup:** ${scenarioSetupContext}

## GRIP EVALUATION SCORES

${gripScores}

**Overall Band:** ${band} (Composite: ${compositeScore}/5)
